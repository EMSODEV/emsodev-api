...
public interface NetCDFgetFilesApi {
    ...
    @ApiOperation(value = "I represents the Time Series retrieved as NETCDF", notes = "Get NetCDF file of a specific Observatory`.", response = File.class, tags={ "Observations Time-series as NetCDF or ODV", })
    @ApiResponses(value = { 
