...
public class NetCDFgetFilesApiController implements NetCDFgetFilesApi {
	...
	public ResponseEntity <NetcdfFileWriteable> netcdfFilesGet( 
			...
			,
			@ApiParam(value = "The end time for the query. The formast must be dd/MM/yyyy. It is require") @RequestParam(value = "endDate", required = true) @DateTimeFormat(pattern="dd/MM/yyyy") Date endDate
