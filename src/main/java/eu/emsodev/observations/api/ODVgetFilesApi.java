...
public interface ODVgetFilesApi {
    ...
    @ApiOperation(value = "It represents the Time Series retrieved as ODV", notes = "Get ODV representation of a dataset for a specific observatory,"
    		+ " instrument and time range. The output is a link which will start the download of the text file.", response = File.class, tags={ "Observation Time-series as NetCDF or ODV", })
    @ApiResponses(value = { 
